...
public class WaveList extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// context menu, activated by long pressing
	...
	public static class WaveAdapter extends ArrayAdapter<Digest> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			TextView title = (TextView) convertView.findViewById(R.id.titleWave);
			...
			unread.setVisibility(unreadCount == 0 ? View.INVISIBLE : View.VISIBLE);
