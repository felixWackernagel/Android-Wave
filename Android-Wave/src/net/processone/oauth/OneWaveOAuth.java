...
public class OneWaveOAuth {	
	private static final String TAG = OneWaveOAuth.class.getSimpleName();
	...
	public OAuthAccessor createOAuthAccessor() {
		OAuthServiceProvider authProvider = new OAuthServiceProvider(
				settings.getOAuthRequestTokenUrl(), 
				settings.getOAuthAuthorizeUrl(),
	...
	public String getUserAuthorizationUrl() {
		...
		try {
			...
			Log.e( TAG, "Error on OAuth authorization.", e );
		}
