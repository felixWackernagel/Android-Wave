...
public class OperationQueue {
  ...
  public Wavelet createWavelet(String domain, Set<String> participants, String message) {
    ...
    if (message != null && !JavaHelper.isEmpty(message)) {
   ...
   *     operation.
   */
  public OperationRequest appendOperation(OperationType opType, Parameter... parameters) {
  ...
  OperationRequest addOperation(OperationType opType, WaveId waveId, WaveletId waveletId,
    ...
    if (proxyForId != null && !JavaHelper.isEmpty(proxyForId)) {
